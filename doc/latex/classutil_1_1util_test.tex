...
checkDate valida que la fecha ingresada sea correcta.\par
 una fecha es correcta si el dia es menor que 28 para el mes 2 o 29 en caso de que el año sea bisiesto.\par
...
daysDiff permite calcular la cantidad de días que un paciente ha estado internado. A partir de las 10:00 de la mañana ya se considera un nuevo día, es decir, si el paciente es dado de alta a las 10:01 ya se le cobra un nuevo día. 
\begin{DoxyParams}{Parameters}
...
Una función que permita calcular el sueldo de un m dico en función de la cantidad de\par
 consultas atendidas al mes, las obras sociales y el valor de la consulta. A este\par
 resultado se le deberá descontar la cantidad de horas que el profesional\par
...
Una función que permita calcular el monto total que debe abonar un paciente\par
 internado en función del costo del día de internación, cantidad y costos de comidas\par
